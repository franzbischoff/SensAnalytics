...
FILE = '/Users/chirathhettiarachchi/Documents/PhD/RA_OHIOH/app/apple_watch/chirath_export.xml'
root = ET.parse(FILE).getroot()
# for type_tag in root.findall('Record'):
#     if type_tag.get('type') == 'HKQuantityTypeIdentifierHeartRateVariabilitySDNN':
#         for tag in root.findall('Record/HeartRateVariabilityMetadataList/InstantaneousBeatsPerMinute'):
#             bpm = tag.get('bpm')
#             time = tag.get('time')
#             print(bpm)
#             print(time)
